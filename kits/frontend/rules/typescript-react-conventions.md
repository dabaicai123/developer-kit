...
2. **Never use `React.FC`** — declare component functions with explicit props parameter: `function Button(props: ButtonProps)`. `React.FC` adds unnecessary `children` typing, hides the props type, and prevents generic components.
