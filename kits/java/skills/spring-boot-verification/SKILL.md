...
> For detailed test patterns, see dedicated skills:
> - `unit-test-service-layer` — Mockito service unit tests
> - `unit-test-controller-layer` — MockMvc REST controller tests
> - `spring-boot-tdd` — TDD workflow with Testcontainers
