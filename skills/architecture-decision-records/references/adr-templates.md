...
5 templates for different decision scenarios. Use the one that matches your decision complexity.

## Template 1: Standard ADR (MADR Format)

Best for: significant technology choices, architecture pattern decisions
...
Best for: smaller decisions, technology adoption within a team
...
Best for: quick decision documentation, decision log entries
...
Best for: superseding previous decisions, technology migration
...
Best for: complex decisions requiring broad input, experimental proposals
