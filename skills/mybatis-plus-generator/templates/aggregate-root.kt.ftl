...
class ${entity} : Serializable {
    ...
    companion object {
         ...
         */
        fun create(): ${entity} {
            // TODO: Implement creation logic, including business rule validation
            val ${entity?substring(0,1)?lower_case}${entity?substring(1)} = ${entity}()
            // TODO: Initialize necessary fields
            // TODO: Publish domain events (e.g., ${entity}CreatedEvent)
...
## ----------  END Aggregate root fields  ----------
    ...
    fun update(${entity?substring(0,1)?lower_case}${entity?substring(1)}: ${entity}) {
        // TODO: Implement update logic, including business rule validation
        // TODO: Verify business invariants
        // TODO: Update fields
        // TODO: Publish domain events (e.g., ${entity}UpdatedEvent)
    }
     ...
     */
    fun delete() {
        // TODO: Implement deletion logic, including business rule validation
        // TODO: Verify if deletion is allowed (e.g., check relationships)
        // TODO: Mark as deleted
        // TODO: Publish domain events (e.g., ${entity}DeletedEvent)
    }
}