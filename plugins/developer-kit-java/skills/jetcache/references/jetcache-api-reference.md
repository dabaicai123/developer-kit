...
QuickConfig qc = QuickConfig.newBuilder("cacheName:")
    ...
    .keyConvertor(KeyConvertor.FASTJSON)        // Key converter
    .serialPolicy(SerialPolicy.KRYO5)           // Value serialization
...
- [`jetcache-annotation-reference.md`](jetcache-annotation-reference.md): 注解完整参数表
- [`jetcache-configuration-reference.md`](jetcache-configuration-reference.md): YAML 配置参考
