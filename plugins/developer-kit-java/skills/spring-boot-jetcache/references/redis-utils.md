...
Common operations utility class based on `RedisTemplate<Object, Object>`.
...
public class RedisUtils {
    ...
    /** Get TopN by score from high to low */
...
> Use JetCache @Cached for caching operations; RedisUtils is only for non-caching scenarios (tokens, counters, temporary data, etc.).